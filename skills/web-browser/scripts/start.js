...
function findChromeBinary() {
  ...
  console.error("✗ No Chrome or Chromium binary found");
  process.exit(1);
}
...
try {
  execSync("killall 'Google Chrome' 2>/dev/null; pkill -f 'chrome.*remote-debugging' 2>/dev/null", { stdio: "ignore" });
} catch {}
...
if (useProfile) {
  ...
  const profileSource = process.platform === "darwin"
